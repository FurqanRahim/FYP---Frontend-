...
const AttendanceReport = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:8080/api/get-attendance', {
    ...
    const fetchLowAttendanceStudents = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:8080/api/low-attendance', {
    ...
    const handleExportAttendance = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:8080/api/export-attendance', {
                params: { classId: selectedClass, courseId: selectedCourse },
    ...
    const handleSendEmails = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8080/api/send-low-attendance-emails', {
