...
const BtnHandleClicking = async (e) => {
  ...
  <img 
    ...
    className="w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full object-cover mx-auto transition-all duration-300 ease-in-out transform"
